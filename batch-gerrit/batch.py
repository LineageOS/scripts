...
parser.add_argument('--query', '-Q', metavar='query', action='store', nargs='?', help='Get changes using query', dest='query', required=False)
...
if not topics and not numbers and query is None:
