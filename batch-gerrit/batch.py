...
parser.add_argument('--query', '-Q', metavar='query', default=None, action='store', nargs='?', help='Get changes using query', dest='query_raw', required=False)
...
if not topics and not numbers and not query:
