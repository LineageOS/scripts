...
class Parser:
    ...
    def __init__(
        ...
        self.imports_cache: Dict[str, Union[Enum, Interface, Parcelable]] = {}
    ...
    def import_aidl(
        ...
        # For all the examples, we consider fqname = "android.hardware.light.ILights"
    ...
    def parse(self, aidl_file: Path) -> Union[Enum, Interface, Parcelable]:
        ...
        for line_number, line in enumerate(aidl_file.read_text().splitlines(), 1):
            ...
            if line.startswith("enum ") or line.startswith("interface ") or line.startswith("parcelable "):
            ...
            if inside_type_definition:
                ...
                if line[0] == '}':
                    assert parsed_block == "", \
                        self._format_error_message(aidl_file, line, line_number, f"Missing semicolon for {parsed_block}")
                ...
                if (is_interface or is_parcelable) and parsed_block.endswith(";"):
                    ...
                    if is_interface:
                        ...
                        interface_methods.append(Method.from_aidl(parsed_block, local_imports))
                    elif is_parcelable:
                        parcelable_fields.append(ParcelableField.from_aidl(parsed_block, local_imports))
        ...
        assert parsed_block == "", \
            self._format_error_message(aidl_file, "", 1, f"Missing semicolon for {parsed_block}")
        ...
        if is_enum:
            ...
            return Parcelable(fqname, parcelable_fields, annotations)
