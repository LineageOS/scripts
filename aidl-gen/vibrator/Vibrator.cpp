...
ndk::ScopedAStatus Vibrator::on(int32_t timeoutMs, IVibratorCallback callback) {
    return ndk::ScopedAStatus::fromExceptionCode(EX_UNSUPPORTED_OPERATION);
}

ndk::ScopedAStatus Vibrator::perform(Effect effect, EffectStrength strength, IVibratorCallback callback, int32_t* _aidl_return) {
    return ndk::ScopedAStatus::fromExceptionCode(EX_UNSUPPORTED_OPERATION);
}
...
ndk::ScopedAStatus Vibrator::compose(std::vector<CompositeEffect> composite, IVibratorCallback callback) {
    return ndk::ScopedAStatus::fromExceptionCode(EX_UNSUPPORTED_OPERATION);
}
