...
def handle_image(image_html, html_id, output_fn):
...
def handle_ota(ota_html, html_id, output_fn):
...
def main():
    ...
    def handle_device(device, build_id, output_fn):
        ...
        handle_image(image_html, html_id, output_fn)
        handle_ota(ota_html, html_id, output_fn)
