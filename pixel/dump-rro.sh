...
beautify_rro_one() {
  ...
  # This can only be done if all device overlays have been beautified to
  # remove shadowed resources from them
...
beautify_rro_chain() {
  ...
  case "$1" in
  gs101)
    beautify_rro_one oriole raviole gs101
    beautify_rro_one raven raviole gs101
    beautify_rro_one raviole gs101
    beautify_rro_one bluejay gs101
    beautify_rro_one gs101
    ;;
  gs201)
    beautify_rro_one cheetah pantah gs201
    beautify_rro_one panther pantah gs201
    beautify_rro_one pantah gs201
    beautify_rro_one lynx gs201
    beautify_rro_one tangorpro gs201
    beautify_rro_one felix gs201
    beautify_rro_one gs201
    ;;
  zuma)
    beautify_rro_one husky shusky zuma
    beautify_rro_one shiba shusky zuma
    beautify_rro_one shusky zuma
    beautify_rro_one akita zuma
    beautify_rro_one zuma
    ;;
  zumapro)
    beautify_rro_one caiman caimito zumapro
    beautify_rro_one komodo caimito zumapro
    beautify_rro_one tokay caimito zumapro
    beautify_rro_one caimito zumapro
    beautify_rro_one comet zumapro
    beautify_rro_one tegu zumapro
    beautify_rro_one zumapro
    ;;
  laguna)
    beautify_rro_one blazer muzel laguna
    beautify_rro_one frankel muzel laguna
    beautify_rro_one mustang muzel laguna
    beautify_rro_one muzel laguna
    beautify_rro_one rango laguna
