...
beautify_rro_chain() {
  ...
  gs101)
    ...
    beautify_rro_one raviole --remove-identical gs101
  ...
  gs201)
    ...
    beautify_rro_one pantah --remove-identical gs201
  ...
  zuma)
    ...
    beautify_rro_one shusky --remove-identical zuma
  ...
  zumapro)
    ...
    beautify_rro_one caimito --remove-identical zumapro
  ...
  laguna)
    ...
    beautify_rro_one muzel --remove-identical laguna
