...
generate_rro() {
  ...
  lineage/scripts/dev/generate_rro.py \
      ...
      --framework "${factory_dir}/system/framework/framework-res.apk" \
...
commonize_rro() {
  ...
  lineage/scripts/dev/commonize_rro.py "${dev_dir}/oriole/overlay" "${dev_dir}/raven/overlay" -o "${dev_dir}/raviole/overlay" -d raviole
  lineage/scripts/dev/commonize_rro.py "${dev_dir}/raviole/overlay" "${dev_dir}/bluejay/overlay" -o "${dev_dir}/gs101/overlay" -d gs101

  lineage/scripts/dev/commonize_rro.py "${dev_dir}/cheetah/overlay" "${dev_dir}/panther/overlay" -o "${dev_dir}/pantah/overlay" -d pantah
  lineage/scripts/dev/commonize_rro.py "${dev_dir}/pantah/overlay" "${dev_dir}/lynx/overlay" "${dev_dir}/tangorpro/overlay" "${dev_dir}/felix/overlay" -o "${dev_dir}/gs201/overlay" -d gs201

  lineage/scripts/dev/commonize_rro.py "${dev_dir}/husky/overlay" "${dev_dir}/shiba/overlay" -o "${dev_dir}/shusky/overlay" -d shusky
  lineage/scripts/dev/commonize_rro.py "${dev_dir}/shusky/overlay" "${dev_dir}/akita/overlay" -o "${dev_dir}/zuma/overlay" -d zuma

  lineage/scripts/dev/commonize_rro.py "${dev_dir}/caiman/overlay" "${dev_dir}/komodo/overlay" "${dev_dir}/tokay/overlay" -o "${dev_dir}/caimito/overlay" -d caimito
  lineage/scripts/dev/commonize_rro.py "${dev_dir}/caimito/overlay" "${dev_dir}/comet/overlay" "${dev_dir}/tegu/overlay" -o "${dev_dir}/zumapro/overlay" -d zumapro

  lineage/scripts/dev/commonize_rro.py "${dev_dir}/blazer/overlay" "${dev_dir}/frankel/overlay" "${dev_dir}/mustang/overlay" -o "${dev_dir}/muzel/overlay" -d muzel
  lineage/scripts/dev/commonize_rro.py "${dev_dir}/muzel/overlay" "${dev_dir}/rango/overlay" -o "${dev_dir}/laguna/overlay" -d laguna
