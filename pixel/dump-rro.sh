...
generate_rro() {
  ...
  lineage/scripts/dev/generate_rro.py \
      ...
      --exclude-overlay com.android.bips.auto_generated_rro_product__ \
      ...
      --exclude-overlay com.android.providers.contacts.auto_generated_rro_product__ \
      --exclude-overlay com.android.providers.media.overlay.pixel \
      --exclude-overlay com.android.simappdialog.auto_generated_rro_product__ \
      --exclude-overlay com.android.systemui.accessibility.accessibilitymenu.auto_generated_rro_product__ \
...
beautify_rro() {
  ...
  lineage/scripts/dev/beautify_rro.py \
      ...
      --keep-resource com.android.settings:regulatory_info_* \
      ...
      --remove-resource android:config_biometricFrrNotificationEnabled \
      ...
      --remove-resource android:config_fingerprintFrrTargetComponent \
      ...
      --remove-resource com.android.settings:face_preview_scale \
      --remove-resource com.android.settings:face_preview_translate_x \
      --remove-resource com.android.settings:face_preview_translate_y \
      --remove-resource com.android.settings:fingerprint_acquired_imager_dirty_udfps \
      ...
      --remove-resource com.android.settings:security_settings_fingerprint_v2_enroll_introduction_footer_message_6 \
      --remove-resource com.android.settings:security_settings_udfps_enroll_fingertip_title \
      --remove-resource com.android.settings:security_settings_udfps_enroll_left_edge_title \
      --remove-resource com.android.settings:security_settings_udfps_enroll_right_edge_title \
