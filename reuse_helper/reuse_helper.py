...
def build_spdx_comment(comment_style, copyright_lines, license_type):
    if comment_style == "java" or comment_style == "c":
        return build_java_spdx_comment(copyright_lines, license_type)
    elif comment_style == "xml":
        return build_xml_spdx_comment(copyright_lines, license_type)
    elif comment_style == "py":
        return build_py_spdx_comment(copyright_lines, license_type)
    else:
        return ""
