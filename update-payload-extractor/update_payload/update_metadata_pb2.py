...
class Extent(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _EXTENT

  # @@protoc_insertion_point(class_scope:chromeos_update_engine.Extent)

class Signatures(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  class Signature(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
...
class PartitionInfo(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _PARTITIONINFO

  # @@protoc_insertion_point(class_scope:chromeos_update_engine.PartitionInfo)

class ImageInfo(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _IMAGEINFO

  # @@protoc_insertion_point(class_scope:chromeos_update_engine.ImageInfo)

class InstallOperation(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _INSTALLOPERATION

  # @@protoc_insertion_point(class_scope:chromeos_update_engine.InstallOperation)

class PartitionUpdate(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _PARTITIONUPDATE

  # @@protoc_insertion_point(class_scope:chromeos_update_engine.PartitionUpdate)

class DeltaArchiveManifest(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
