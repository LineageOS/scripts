...
if __name__ == '__main__':
    ...
    system_groups, vendor_groups = get_groups(args.system_filesystem_config_path,
    ...
    with open(args.vendor_fs_config_files_path, 'rb') as file:
        while True:
            ...
            print('user: {}'.format(gid_to_str(uid, system_groups, vendor_groups)))
            print('group: {}'.format(gid_to_str(gid, system_groups, vendor_groups)))
