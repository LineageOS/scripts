...
```
  Example usage:
    $ ./config-fs-gen.py ~/lineage-16.0/kernel/oneplus/sm8150/include/uapi/linux/capability.h ~/lineage-16.0/system/core/libcutils/include/private/android_filesystem_config.h ~/lineage-16.0/out/target/product/guacamole/vendor/etc/group ~/lineage-16.0/out/target/product/guacamole/system/etc/{fs_config_dirs,fs_config_files}
    [AID_VENDOR_QTI_DIAG]
    value:2901
