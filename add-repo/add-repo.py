...
def parse_cmdline() -> argparse.Namespace:
    ...
    subparser = subparsers.add_parser("add-project")
    subparser.add_argument("--file", help="Path to output manifest XML", required=True)
    ...
    subparser = subparsers.add_parser("add-remote")
    subparser.add_argument("--file", help="Path to output manifest XML", required=True)
