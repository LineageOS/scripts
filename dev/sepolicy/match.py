...
def remove_source_rule_matches(
    all_rule_matches: Set[RuleMatch],
    ...
    color_print(
        f'Removed {len(removed_rule_matches)} macros also in source',
        color=Color.GREEN,
    )
    color_print(
        f'Removed {len(removed_rules_in_matches)} rules from macros also in source',
        color=Color.GREEN,
    )
